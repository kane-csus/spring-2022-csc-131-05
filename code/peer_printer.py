...
def main():
    ...
    peers = [ashley_palencia_wisniewski, brandon_symansiv, darryl_nguyen, emrys_poggemann, enrique_alcacer, gary_kane, ian_schultz,jasmine_randhawa,jesus_cervantes, joseph_doan, nikita_cherepanov, riley_johnson, vaibhav_jain]
